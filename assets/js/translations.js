...
const translations = {
    ...
    fa: {
        ...
        'product.jojo.description': 'جوجو یه اپلیکیشن چک‌لیستیه که بهتون کمک می‌کنه کارهاتون رو با قالب‌های آماده و سفارشی راحت مدیریت کنید.',
        ...
        'app.jojo.description': 'جوجو بهتون کمک می‌کنه کارهاتون رو با قالب‌های آماده و سفارشی راحت مدیریت کنید. چه بخواید روزتون رو برنامه‌ریزی کنید، پروژه‌ها رو مدیریت کنید یا اهدافتون رو دنبال کنید، جوجو همه چیز رو ساده و قابل فهم می‌کنه. منظم بمونید و با جوجو بهره‌ورتر بشید!',
        ...
        // Terms of Use
        'app.terms.title': 'قوانین استفاده - جوجو',
        'app.terms.intro': 'با دانلود و استفاده از اپلیکیشن "جوجو"، شما با این قوانین استفاده موافقت می‌کنید. لطفاً اون‌ها رو با دقت بخونید.',
        'app.terms.acceptance.title': '۱. پذیرش قوانین',
        'app.terms.acceptance.content': 'استفاده شما از اپلیکیشن "جوجو" به معنای پذیرش کامل این قوانینه. اگه با هر بخشی از این قوانین موافق نیستید، لطفاً از استفاده از اپلیکیشن خودداری کنید.',
        'app.terms.service.title': '۲. توضیحات سرویس',
        'app.terms.service.content': '"جوجو" یه اپلیکیشن چک‌لیست ساده و آفلاینه که به کاربران امکان ایجاد و مدیریت لیست کارهای شخصی خودشون رو در گوشی‌های موبایل می‌ده. این اپلیکیشن به اینترنت نیاز نداره.',
        ...
        'app.terms.intellectual.content': 'تمام حقوق مالکیت معنوی مربوط به اپلیکیشن "جوجو" (شامل کد، طراحی، رابط کاربری، نام و لوگو) متعلق به توسعه‌دهنده اونه و تحت قوانین کپی‌رایت محافظت می‌شه.',
        'app.terms.liability.title': '۵. محدودیت مسئولیت',
        'app.terms.liability.content1': 'اپلیکیشن "جوجو" "همونطور که هست" ارائه می‌شه. توسعه‌دهنده هیچ تضمین صریح یا ضمنی در مورد عملکرد بدون وقفه یا بدون خطای اپلیکیشن ارائه نمی‌ده.',
        ...
        // Privacy Policy
        'app.privacy.title': 'حریم خصوصی - جوجو',
        'app.privacy.intro': 'از اعتمادتون و استفاده از اپلیکیشن "جوجو" ممنونیم. این اپلیکیشن به عنوان یه چک‌لیست ساده و کاملاً آفلاین طراحی شده. حریم خصوصی شما برای ما خیلی مهمه. این سند توضیح می‌ده که چطور اطلاعات شما رو جمع‌آوری، استفاده و محافظت می‌کنیم.',
        'app.privacy.collection.title': '۱. جمع‌آوری اطلاعات',
        'app.privacy.collection.content': 'اپلیکیشن "جوجو" به صورت کاملاً آفلاین کار می‌کنه. این یعنی:',
        ...
        'app.privacy.permissions.content': 'اپلیکیشن "جوجو" برای عملکرد اصلی خودش به هیچ دسترسی خاصی از دستگاه شما (مثل دوربین، میکروفون، موقعیت مکانی، مخاطبین و غیره) نیاز نداره. اگه در آینده قابلیتی اضافه بشه که نیازمند دسترسی باشه، از شما به صورت شفاف اجازه گرفته می‌شه و دلیلش توضیح داده می‌شه.',
